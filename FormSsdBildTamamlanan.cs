...
namespace R0G_DI7
{
    public partial class FormSsdBildTamamlanan : Form
    {
        public FormSsdBildTamamlanan()
        {
            InitializeComponent();
        }
        ...
        private void FormSsdBildTamamlanan_Load(object sender, EventArgs e)
        {
            metot();
            ...
            SqlDataAdapter da = new SqlDataAdapter("select * from tblbild_urun where urun_surec=2", baglanti);
